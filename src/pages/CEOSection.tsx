      ...
      <div className='container'>
          ...
          <motion.div className='space-y-6' variants={itemVariants}>
            <div>
              ...
              <p className='text-lg text-foreground/80 leading-relaxed mb-4'>
                Dr. Amara Okafor is a visionary environmental engineer and
                social entrepreneur with over two decades of experience in
                sustainable waste management. She founded Waste Wise
                Humanitarian Initiative with a mission to transform how Nigeria
                manages waste—turning environmental challenges into economic
                opportunities.
              </p>
            </div>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div className='bg-gradient-to-br from-primary/40 to-secondary/40 backdrop-blur-md border border-white/20 rounded-lg p-4'>
        ...
        >
          <motion.p
            ...
            variants={itemVariants}
          >
            Interested in partnering with WHI or inviting Dr. Amara to speak?
          </motion.p>
          <motion.button
