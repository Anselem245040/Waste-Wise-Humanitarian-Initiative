  ...
  const serviceDetails: ServiceDetail[] = [
    {
      ...
      description:
        "We organize large-scale community cleanup initiatives that bring together volunteers, local leaders, and residents to restore public spaces and improve environmental quality.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "We provide comprehensive waste management solutions tailored to corporate clients, including recycling programs, waste audits, and sustainability consulting.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Our innovative tech platform enables real-time waste tracking, impact measurement, and community engagement through mobile applications and data analytics.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "We conduct comprehensive educational programs in schools and communities to raise awareness about waste management and sustainable living practices.",
      benefits: [
        ...
        <div className='container relative z-10'>
          ...
          >
            ...
            <p className='text-xl text-foreground/60'>
              Discover how we're revolutionizing waste management through
              innovative solutions, community engagement, and sustainable
              practices.
            </p>
          </motion.div>
        </div>
          ...
          {serviceDetails.map((service, index) => (
            ...
            >
              ...
              <div className={index % 2 === 1 ? "md:order-2" : ""}>
                <div
                  className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br ${service.color} text-white mb-4`}
                >
                  {service.icon}
                </div>
        ...
        >
          <div className='relative z-10'>
            ...
            <p className='text-white/90 text-lg mb-8 max-w-2xl mx-auto'>
              Partner with us to implement sustainable waste management
