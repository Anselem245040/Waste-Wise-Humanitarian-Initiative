...
export default function ImpactDetailsSection() {
  ...
  return (
    <section id="impact-details" className="py-16 md:py-24 bg-background">
        ...
        >
          {globalMetrics.map((metric, idx) => {
            ...
            return (
              <motion.div
                key={idx}
                className="bg-white/50 backdrop-blur-md border border-white/20 rounded-2xl p-6 text-center hover:shadow-lg hover:scale-105 transition-all duration-300"
                variants={itemVariants}
              >
