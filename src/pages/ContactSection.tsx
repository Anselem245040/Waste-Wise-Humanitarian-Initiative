        ...
        >
          {contactInfo.map((info, idx) => {
            ...
            return (
              <motion.div
                key={idx}
                className="bg-white/50 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:shadow-lg hover:scale-105 transition-all duration-300 group"
                variants={itemVariants}
              >
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <form
              ...
              className="bg-white/50 backdrop-blur-md border border-white/20 rounded-2xl p-8 md:p-10"
            >
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-white/50 border border-border/40 text-foreground placeholder:text-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-4 py-3 rounded-lg bg-white/50 border border-border/40 text-foreground placeholder:text-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all resize-none"
                    required
                  />
                </div>
          ...
          >
            {/* Map Placeholder */}
            <div className="bg-white/50 backdrop-blur-md border border-white/20 rounded-2xl overflow-hidden h-80 flex items-center justify-center">
            ...
            <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-2xl p-8 border border-primary/20">
              ...
              <div className="space-y-4">
                <div>
                  <p className="font-semibold text-primary mb-1">Lagos Office</p>
                  <p className="text-foreground/70">
                    Plot 123, Lekki Phase 1, Lagos
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-primary mb-1">Abuja Office</p>
                  <p className="text-foreground/70">
                    Suite 456, Central Business District, Abuja
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-primary mb-1">Port Harcourt Office</p>
                  <p className="text-foreground/70">
