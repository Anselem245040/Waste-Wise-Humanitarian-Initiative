...
import { Heart, MessageCircle, Share2, Music2, ExternalLink } from "lucide-react";
...
export default function SocialMediaFeed() {
  const [activeFilter, setActiveFilter] = useState<"all" | "instagram" | "twitter" | "facebook" | "linkedin" | "tiktok">("all");
  ...
  const socialPosts: SocialPost[] = [
    {
      ...
      shares: 0,
      url:
        "https://www.linkedin.com/posts/waste-wise-humanitarian-initiative-whi_the-world-is-evolving-tomorrow-theres-activity-7468228687868645376-HIF0?utm_source=share&utm_medium=member_android&rcm=ACoAAFXklfgBxgexAC22q8Kgb0GEbx9tpvTZT4g",
    },
    {
      id: "ln2",
      platform: "linkedin",
      ...
      shares: 0,
      url:
        "https://www.linkedin.com/posts/waste-wise-humanitarian-initiative-whi_the-d-day-is-here-the-day-when-the-world-activity-7468585438249930752-Svfs?utm_source=share&utm_medium=member_android&rcm=ACoAAFXklfgBxgexAC22q8Kgb0GEbx9tpvTZT4g",
    },
  ];
  ...
  const platformColors: Record<string, { bg: string; icon: any; color: string }> = {
    instagram: { bg: "from-pink-500 to-rose-500", icon: ExternalLink, color: "text-pink-500" },
    twitter: { bg: "from-blue-400 to-blue-600", icon: ExternalLink, color: "text-blue-500" },
    facebook: { bg: "from-blue-600 to-blue-800", icon: ExternalLink, color: "text-blue-700" },
    linkedin: { bg: "from-blue-700 to-blue-900", icon: ExternalLink, color: "text-blue-800" },
  ...
  return (
    <section id="social-feed" className="py-16 md:py-24 bg-gradient-to-b from-background to-muted/30">
      <div className="container">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Follow our latest community cleanups, environmental tips, and impact stories across all platforms
          </motion.p>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          {["all", "instagram", "twitter", "facebook", "linkedin", "tiktok"].map((platform) => {
            const isActive = activeFilter === platform;
            const platformConfig = platformColors[platform as keyof typeof platformColors];
            ...
            return (
              ...
              >
                ...
                <span className="capitalize">{platform === "all" ? "All Posts" : platform}</span>
              </motion.button>
            );
          })}
        </motion.div>
                ...
                >
                  ...
                  >
                    <div className="bg-white/50 backdrop-blur-md border border-white/20 rounded-2xl overflow-hidden hover:shadow-xl hover:border-white/40 transition-all duration-300 h-full flex flex-col group-hover:scale-105">
                      ...
                      <div className={`bg-gradient-to-r ${platformConfig.bg} p-4 flex items-center justify-between`}>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-white/80 text-xs">{post.handle}</p>
                          </div>
                        </div>
                      ...
                      <div className="p-4 flex-1 flex flex-col">
                        ...
                        <p className="text-xs text-foreground/50 mt-auto">{post.timestamp}</p>
                      </div>
        ...
        >
          <p className="text-foreground/70 mb-6">
            Follow us on social media for daily updates, tips, and community stories
          </p>
